...
// 项目本身需要的变量
export const cssVariableDark: Record<string, string> = {
  ...
  "--g-color-title": color2rgba("#FFFFFF", 0.9), // 标题文字颜色
  "--g-color-text": color2rgba("#FFFFFF", 0.88), // 正文文字颜色
  "--g-color-desc": color2rgba("#FFFFFF", 0.7), // 描述文字颜色
  "--g-color-divider-line": color2rgba("#FFFFFF", 0.3), // 分割线颜色

  "--g-layout-bg": "#0A0A0A", // 布局背景色
  "--g-container-bg": "#141414", // 组件容器背景色
  "--g-container-border": "#424242", // 组件容器边框色
  "--g-container-border-radius": "4px", // 组件容器边框圆角

  "--g-scrollbar-thumb-bg": "#273455", // 滚动条颜色
  "--g-scrollbar-thumb-hover-bg": "#364672", // 滚动条悬停颜色

  "--vxe-font-family": fontFamily, // 字体系列
  "--vxe-font-size": "12px", // 字体大小
  "--vxe-font-color": color2rgba("#FFFFFF", 0.88), // 字体颜色
  "--vxe-table-header-font-color": color2rgba("#FFFFFF", 0.88), // 表格表头字体颜色
  ...
  "--vxe-table-border-color": "#363637", // 表格边框宽度
  "--vxe-table-resizable-line-color": "#3E424D", // 表格可调整大小线条颜色
  ...
  "--vxe-table-row-current-background-color": "#18222C", // 表格当前行背景颜色
  "--vxe-table-row-hover-background-color": "#262727", // 表格鼠标悬停行背景颜色
  "--vxe-table-row-hover-current-background-color": "#262727", // 表格鼠标悬停当前行背景颜色
  "--vxe-table-row-hover-striped-background-color": "#262727", // 表格鼠标悬停斑马纹行背景颜色
  "--vxe-table-row-hover-checkbox-checked-background-color": "#262727", // 表格鼠标悬停复选框选中行背景颜色
  "--vxe-table-row-striped-background-color": "#1D1D1D", // 表格斑马纹行背景颜色
  "--vxe-table-row-checkbox-checked-background-color": "#18222C", // 表格复选框选中行背景颜色
