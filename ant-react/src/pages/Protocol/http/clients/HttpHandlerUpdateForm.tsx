...
export type UpdateFormProps = {
  onCancel: (flag?: boolean, formVals?: API.HttpHandlerListItem) => void;
  onSubmit: (values: API.HttpHandlerListItem) => Promise<void>;
  updateModalOpen: boolean;

  values: API.HttpHandlerListItem;
};
const HttpHandlerUpdateForm: React.FC<UpdateFormProps> = (props) => {
...
export default HttpHandlerUpdateForm;
