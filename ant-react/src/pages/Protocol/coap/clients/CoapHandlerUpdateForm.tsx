...
export type UpdateFormProps = {
  onCancel: (flag?: boolean, formVals?: API.CoapHandlerListItem) => void;
  onSubmit: (values: API.CoapHandlerListItem) => Promise<void>;
  updateModalOpen: boolean;

  values: API.CoapHandlerListItem;
};
const CoapHandlerUpdateForm: React.FC<UpdateFormProps> = (props) => {
...
export default CoapHandlerUpdateForm;
