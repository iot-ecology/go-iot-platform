...
export type UpdateFormProps = {
  onCancel: (flag?: boolean, formVals?: API.ScriptWaringParamListItem) => void;
  onSubmit: (values: API.ScriptWaringParamListItem) => Promise<void>;
  updateModalOpen: boolean;

  values: API.ScriptWaringParamListItem;
};
const ScriptParamUpdateForm: React.FC<UpdateFormProps> = (props) => {
...
export default ScriptParamUpdateForm;
