import { waringHistory } from '@/services/ant-design-pro/api';
...
const WaringHistoryList: React.FC<Props> = (props) => {
  ...
  const handleDateChange = async (dates, dateStrings) => {
    ...
    let c = await waringHistory(parm);
    setParam(c.data);
  };
...
export default WaringHistoryList;
