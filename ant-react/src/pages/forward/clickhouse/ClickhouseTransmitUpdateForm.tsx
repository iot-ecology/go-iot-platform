...
export type UpdateFormProps = {
  onCancel: (flag?: boolean, formVals?: API.ClickhouseTransmitListItem) => void;
  onSubmit: (values: API.ClickhouseTransmitListItem) => Promise<void>;
  updateModalOpen: boolean;

  values: API.ClickhouseTransmitListItem;
};
const ClickhouseTransmitUpdateForm: React.FC<UpdateFormProps> = (props) => {
...
export default ClickhouseTransmitUpdateForm;
