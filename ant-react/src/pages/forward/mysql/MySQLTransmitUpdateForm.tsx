...
export type UpdateFormProps = {
  onCancel: (flag?: boolean, formVals?: API.MySQLTransmitListItem) => void;
  onSubmit: (values: API.MySQLTransmitListItem) => Promise<void>;
  updateModalOpen: boolean;

  values: API.MySQLTransmitListItem;
};
const MySQLTransmitUpdateForm: React.FC<UpdateFormProps> = (props) => {
...
export default MySQLTransmitUpdateForm;
